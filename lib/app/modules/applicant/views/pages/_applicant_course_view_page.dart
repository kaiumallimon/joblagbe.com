...
class ApplicantCourseViewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller =
        Get.put(ApplicantCourseViewController(course: course), tag: course.id);
...
class ApplicantCourseViewPageWithId extends StatelessWidget {
  const ApplicantCourseViewPageWithId({super.key, required this.courseId});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<Course?>(
      future: ApplicantCourseService().getAllCourses().then(
      ...
      builder: (context, snapshot) {
            ...
            body: Center(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 16),
                  ElevatedButton(
                    onPressed: () => context.go('/dashboard/applicant/courses'),
        ...
        return ApplicantCourseViewPage(course: snapshot.data!);
      },
    );
  }
}
